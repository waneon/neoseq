...
export default function App() {
  ...
  useEffect(() => {
    ...
    void Promise.all([
      ...
      .then(() => {
        if (!cancelled) setState({ status: "passed", persistence: true, corePort: true, recovery: true });
      })
      .catch((error) => {
  ...
  return (
    <main>
      ...
      <p>SQLite and IndexedDB implement one recovery and CorePort v1 contract.</p>
      <section
        aria-live="polite"
        data-testid="result"
