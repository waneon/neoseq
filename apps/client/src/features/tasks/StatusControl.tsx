    ...
    <DropdownMenu modal={false}>
      ...
      <DropdownMenuContent align="start" aria-label={message("task.statusLabel")}>
        {/* The group owns `aria-checked`; each row owns what choosing it does.
            Leaving the write to `onValueChange` would mean the one row whose
            verb is not "become this value" — `Complete occurrence` on a task
            already sitting at `done` — silently did nothing. */}
