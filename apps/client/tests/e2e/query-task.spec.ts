...
test("query-task projections share ordinary properties and the SPARQL index", async ({ page }) => {
  ...
  await expect(page.getByTestId("prop-query.language")).toContainText("sparql-1.1/neoseq-v1");
