...
Playwright run owns the preview server — on its default port, or on
`NEOSEQ_PREVIEW_PORT` when a development server already holds it — and schedules
every browser project. The
