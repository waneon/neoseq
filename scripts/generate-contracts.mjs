...
pub const MIN_MIGRATABLE_SCHEMA_VERSION: u32 = ${graphSchema.minMigratable};
/// Schema a writer must support before it may modify a current graph.
pub const MINIMUM_WRITER_SCHEMA: u32 = ${graphSchema.minimumWriter};
`;
...
export const MIN_MIGRATABLE_SCHEMA_VERSION = ${graphSchema.minMigratable} as const;
export const MINIMUM_WRITER_SCHEMA = ${graphSchema.minimumWriter} as const;
`;
